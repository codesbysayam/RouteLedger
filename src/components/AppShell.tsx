...
export const AppShell: React.FC<AppShellProps> = ({
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-[#EEF3F8] text-[#172033]">
      {/* Desktop Sidebar */}
      ...
      <div className="flex-1 flex flex-col min-w-0 min-h-0 h-full overflow-hidden">
        ...
        <main id="app-workspace-container" className="flex-1 min-h-0 h-full overflow-y-auto overflow-x-hidden rl-workspace bg-technical-canvas">
